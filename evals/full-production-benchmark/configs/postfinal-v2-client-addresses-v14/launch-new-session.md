# Чистый full-production benchmark v14: «Блок “Адреса клиента”»
...
```text
evals/full-production-benchmark/configs/postfinal-v2-client-addresses-v14/shadow-benchmark-config.json
```

Ожидаемый SHA-256 конфигурации:

```text
5c73376f90b16025ddb5f897864b496782f4d39a7c0bc0c87187c339ed5978ad
```
...
- Не читай и не передавай writer/reviewer старые test cases, результаты v13, старые review cycles или canonical baseline.
- Не пиши тест-кейсы вручную внутри root-agent.
- Не используй retry, fallback, resume или продолжение v13.
...
```text
fts/AutoFin/work/stage-handoffs/94-application-card-client-addresses-v14
fts/AutoFin/work/review-cycles/application-card-client-addresses-v14-20260720
fts/AutoFin/test-cases/4.3-application-card-client-addresses-shadow-20260720-v14.md
```
