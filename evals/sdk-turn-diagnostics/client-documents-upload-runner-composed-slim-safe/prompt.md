...
diagnostic_output_dir: C:\Users\Пользователь\Documents\Виталя\GitProjects\qa-agent-v2\evals\sdk-turn-diagnostics\client-documents-upload-runner-composed-slim-safe
...
active_prompt_path: C:\Users\Пользователь\Documents\Виталя\GitProjects\qa-agent-v2\fts\ft-2-OF_17\work\review-cycles\client-documents-upload-and-actuality\prompts\prompt.structure-preflight-r1.md
...
- Do not rerun the instruction resolver unless this manifest is visibly inconsistent.
