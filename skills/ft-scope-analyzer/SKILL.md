...
исполнителя, объект/состояние, статус и `Подтверждение подготовки`: fixture,
воспроизводимые шаги или причину отсутствия подготовки. `Тестировщик` не
подтверждает права; неподтверждённый актор, статус или объект — `needs-test-data`.
