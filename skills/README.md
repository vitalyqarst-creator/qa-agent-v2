...
Обязательные проверки переходов: `scripts/runtime_session_registry.py`, `scripts/validate_runtime_scope.py`, `scripts/validate_runtime_matrix.py` с inventory/gaps и `scripts/validate_runtime_tc.py` с matrix.
