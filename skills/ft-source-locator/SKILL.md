...
6. Временные рендеры создавай только в системном временном каталоге и удали созданный каталог. Затем обязательно запусти `python scripts/validate_runtime_source.py <package-root> <source-handoff-dir>`. Без `valid=true` этап не завершён.
