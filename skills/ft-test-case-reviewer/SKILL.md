...
1. Восстанови требования из источников самостоятельно. Не считай matrix или
   TC достаточным доказательством требования.
...
5. После одной writer revision проверяй только исходные findings и связанные
   с ними регрессии. Если существенный finding сохраняется, зафиксируй
   `review-failed`; не запускай новую итерацию.
