...
Только канонические артефакты v0.9, перечисленные в маршруте: пакетный source manifest, обязательства scope, matrix, TC и независимые review-артефакты при требуемых переходах.
