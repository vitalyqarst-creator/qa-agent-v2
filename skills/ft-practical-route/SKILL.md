...
1. Resolve DOCX, XHTML, stable support, existing `AGENT-NOTES.md`, visual references and an available PDF. Create `source-package-manifest.json`: support и visual-only inputs регистрируй раздельно.
