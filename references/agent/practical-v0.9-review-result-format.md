...
правильно выведен из предпосылок, но остаётся другое существенное ограничение,
finding не требует сменить primary статус: он требует поле «Ограничения
исполнения» с русским пояснением и связанным `SETUP-*`. При одном точном
