...
For ordinary work use `practical-v0.9` from
`references/agent/practical-test-case-route-v0.9.md`. This session-based
reference is explicit-only and does not replace its mandatory matrix/TC review
contracts or controller-owned session attestation.
