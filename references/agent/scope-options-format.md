...
| --- | --- | --- |
| `AS.3`; таблица 2 | `9.3.1-perechen-partnerov` | Описывает тот же экран и его перечень. |
| `AS.5` | `9.3-obshchie-pravila` | Правило дубликатов распространяется на несколько карточек. |
...
| Якорь ФТ | Назначение | Обоснование |
| --- | --- | --- |
| `GSR 22` | `2.1-lichnaya-informaciya` | Проверяется на том же экране. |
