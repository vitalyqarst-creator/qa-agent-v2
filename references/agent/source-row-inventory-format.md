# Формат реестра строк источника

`source-row-inventory.md` — обязательный реестр строк источника, если scope строится по таблицам полей, таблицам действий, XHTML/PDF/DOCX extraction или другому табличному источнику. В practical handoff видимый заголовок файла: `# Реестр строк источника`; технические идентификаторы столбцов таблицы сохраняются в каноническом виде.
