...
```json
{
  ...
  "groups": {
    ...
    "writer_validator_failure_deep": {
      ...
      "paths": [
        ...
        "references/qa/coverage-checklist.md"
      ]
    },
    "source_locator_core": {
  ...
  "scenarios": [
    ...
    },
    {
      ...
      "audit_only_groups": ["audit_only_history", "governance_audit_only"],
      "budget_limit_kib": 410,
      "rationale": "End-to-end session-based writer/reviewer orchestration context; table/UI details remain conditional to the concrete scope profile and semantic reviewer safeguards remain required."
    },
    {
