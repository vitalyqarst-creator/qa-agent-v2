...
```json
{
  ...
  "groups": {
    ...
    "reviewer_prepared_package_core": {
      "rationale": "Isolated semantic reviewer fast path for an eligible verified prepared package; the full reviewer skill and deep rubric remain standard-reviewer only.",
      "paths": [
