...
```json
{
  ...
  "groups": {
    ...
    "controlled_traceability_update": {
      "rationale": "Safe workflow for traceability-only backfill, reviewed writer traceability update apply, post-apply validation and completed-package regression.",
      "paths": [
        "references/agent/controlled-traceability-update-workflow.md",
        "references/agent/controlled-traceability-update-checklist.md",
        "references/agent/traceability-mismatch-diagnostics-format.md",
        "references/agent/traceability-repair-strategy-format.md",
        "references/agent/traceability-backfill-proposal-format.md",
        "references/agent/traceability-backfill-review-format.md",
        "references/agent/traceability-backfill-apply-format.md",
        "references/agent/writer-dry-run-proposal-format.md",
        "references/agent/writer-proposal-review-format.md",
        "references/agent/writer-traceability-update-apply-format.md",
        "references/agent/writer-traceability-post-apply-validation-format.md",
        "references/agent/completed-package-regression-format.md"
      ]
    },
    "source_locator_core": {
