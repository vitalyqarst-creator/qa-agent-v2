...
```json
{
  ...
  "groups": {
    ...
    "lean_v2_core": {
      "rationale": "Conditional deterministic-first iteration over compiler-v3 obligations and an independently accepted v4 source contract; excluded from ordinary full-loop and bounded-production contexts.",
      "paths": [
        "skills/ft-test-case-iteration/SKILL.md",
    ...
    "deterministic_production_core": {
      "rationale": "Single public schema-v2 deterministic-first production route; qualification-only orchestration and compatibility control planes are excluded.",
      "paths": [
        "skills/ft-test-case-iteration/SKILL.md",
        "references/agent/lean-v2-iteration.md",
        "references/agent/negative-ui-calibration-policy.md"
  ...
  "scenarios": [
    ...
    },
    {
      ...
      "audit_only_groups": ["audit_only_history", "governance_audit_only"],
      "budget_limit_kib": 271,
      "rationale": "Manual scope selection when the user already provides the intended section or boundary. The 271 KiB cap preserves the mandatory source-assertion/gap/clarification and promotion-recovery contracts plus at least 15 KiB safety headroom; it is an instruction-context cap, not a release-quality waiver."
    },
    {
    ...
    },
    {
      ...
      "audit_only_groups": ["audit_only_history", "governance_audit_only"],
      "budget_limit_kib": 90,
      "rationale": "Short deterministic-first iteration with zero writer calls for template-complete cards, at most one writer for complex cards and one independent reviewer."
    },
    {
