...
```json
{
  ...
  "groups": {
    ...
    "lean_v2_core": {
      "rationale": "Conditional deterministic-first iteration over an already localized atomic source packet; excluded from ordinary full-loop and bounded-production contexts.",
      "paths": [
        "skills/ft-test-case-iteration/SKILL.md",
