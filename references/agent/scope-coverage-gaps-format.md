...
- Значения пояснительных полей (`Description`, missing behavior/oracle, handling и downstream rules) пиши по-русски; schema labels, IDs и буквальная source quote могут оставаться каноническими.
