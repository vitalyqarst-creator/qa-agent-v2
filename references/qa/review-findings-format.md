...
- `category` = `coverage | atomarity | traceability | expected-result | scope | duplication | format | structure | test-design | test-design-depth | tc-set-optimization | over-testing | clarification-question-quality`
