...
- не считать кейс automation-ready, если `Предусловия` требуют специального UI-состояния, но не дают numbered setup steps, fixture/API setup или reusable setup profile.
