...
class AgentArchitectureTests(unittest.TestCase):
    ...
    def test_readme_and_contributing_document_canonical_test_command(self) -> None:
        ...
        self.assertIn("python scripts/run_tests.py", contributing)
        self.assertIn("python -m unittest discover -s tests", contributing)
        self.assertIn("python -m unittest", contributing)
    ...
    def test_session_based_review_cycle_contract_is_wired(self) -> None:
        ...
        self.assertIn("Session-based review cycle and Codex SDK orchestration", index)
    ...
    def test_run_tests_script_uses_discovery_for_full_suite(self) -> None:
