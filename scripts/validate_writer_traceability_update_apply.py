...
def main() -> int:
    ...
    payload = {
        ...
        "final_state_valid": report.final_state_valid,
        "git_change_state": report.git_change_state,
        "safe_to_commit": report.safe_to_commit,
        "safe_for_next_stage": report.safe_for_next_stage,
        "commit_action": report.commit_action,
