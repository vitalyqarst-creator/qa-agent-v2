...
| `ATOM-004` | `WP-01` | `SP-004` | `BSR 38` | `SRC-002` | При нажатии на кнопку `Кредитный калькулятор` открывается окно `Кредитный калькулятор`. | `covered` | `TC-ACCS-004` | `TC-ACCS-004` | `none_required:covered` | `-` |
| `ATOM-005` | `WP-01` | `SP-005` | `BSR 38` | `SRC-002` | Окно `Кредитный калькулятор` содержит предзаполненные данные по заявке; состав полей и mapping к данным заявки в доступном ФТ не определены. | `gap` | `none_required:gap` | `GAP-001` | `GAP-001` | `-` |
