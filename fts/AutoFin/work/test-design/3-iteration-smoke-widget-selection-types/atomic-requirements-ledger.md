...
| --- | --- | --- | --- | --- | --- | --- |
| `ATOM-001` | `SRC-001` | `no_requirement_code:SRC-001` | Виджет типа `Список` использует значения из справочника. | `covered` | `TC-WIDGET-SELECTION-TYPES-001` | Проверяется через два зафиксированных активных справочных значения выбранного fixture-виджета. |
...
| `ATOM-003` | `SRC-002` | `no_requirement_code:SRC-002` | Виджет типа `Список с множественным выбором` использует значения из справочника. | `covered` | `TC-WIDGET-SELECTION-TYPES-002` | Проверяется через два зафиксированных активных справочных значения выбранного fixture-виджета. |
