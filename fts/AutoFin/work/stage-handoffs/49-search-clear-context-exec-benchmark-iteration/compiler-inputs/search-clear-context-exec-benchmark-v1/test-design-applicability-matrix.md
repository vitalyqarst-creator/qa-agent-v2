...
| `state` | `yes` | `BSR 32; SRC-001` | Each test creates a changed UI state and verifies its reset. | `ATOM-001; ATOM-002; ATOM-003; ATOM-004` | `TC-SCCB-001; TC-SCCB-002; TC-SCCB-003; TC-SCCB-004` | `none_required` |
| `default-state` | `yes` | `BSR 32; SRC-001` | Reset is compared with initial state captured in the same session; exact defaults are not asserted. | `ATOM-001; ATOM-002; ATOM-003; ATOM-004` | `TC-SCCB-001; TC-SCCB-002; TC-SCCB-003; TC-SCCB-004` | `none_required` |
