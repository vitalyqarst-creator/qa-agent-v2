...
| `DEC-002` | 2 | `architecture` | V3 passed deterministic gates but reviewer rejected execution detail | Add compiler and runner enforcement | Compiler should stop bad prepared inputs; runner must independently verify generated draft | code/tests/eval fixture | high | in-progress |
