...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `SO-NEG-NA-001` | `SRC-001`; `SRC-002` | calculator-summary widget and button | `other` | `none` | Final rows define positive visibility, content and navigation only. | `not_derived` | `no` | `not_found` | `not-testable-gap` | `not_applicable` | `not_applicable:no-negative-class-in-selected-source` | `none_required:covered` | `none_required` | Do not create negative TC unless a later source adds an invalid class. | `not_applicable` |
...
- Не придумывать invalid values, сообщения или blocked transitions для выбранных строк.
