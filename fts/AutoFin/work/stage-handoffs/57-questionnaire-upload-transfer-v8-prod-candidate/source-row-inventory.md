# Source Row Inventory — Questionnaire Upload Transfer V8 Prod Candidate
...
- `О` и `Р` интерпретируются только через `AGENT-NOTES.md`.
- H56/H55 drafts и production test cases не являются source evidence.
