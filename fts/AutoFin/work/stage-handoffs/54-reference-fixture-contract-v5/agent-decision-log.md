...
| `DEC-008` | 8 | `validation` | V5 reviewer accepted 13/13 | Закрыть canary как accepted-not-promoted и не повторять | Semantic blocker устранён; production boundary намеренно сохранена | `terminal-stop-gate.v5.md` | high | applied |
| `DEC-009` | 9 | `architecture` | Accepted V5 uses 4 079,08 uncached tokens/OBL | Следующим проверять transfer и measured context duplication | Новый scope лучше выявит overfitting, чем повтор того же fixture | `prompt.reference-fixture-v5-to-next.md` | medium | proposed |
