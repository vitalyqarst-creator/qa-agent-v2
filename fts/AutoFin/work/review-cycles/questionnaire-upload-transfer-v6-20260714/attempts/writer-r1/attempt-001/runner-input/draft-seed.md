...
[SEED:observable oracle] Информационное поле отображается всегда.
...
[SEED:observable oracle] Файл ровно 41 943 040 байт добавляется успешно.
...
[SEED:observable oracle] Файл 41 943 041 байт не добавляется; отображается `Документы не загружены. Проверьте соответствуют ли документы требованиям: формат jpg, png, pdf, размер не более 40 МБ`.
