...
Сохранить `ATOM-008` / `OBL-QUT-008` как отдельный gap; не создавать exact-boundary/just-over byte TC. Writer и reviewer могут обработать остальные 10 testable obligations при явном сохранении этого ограничения.
...
```json
{
  "artifact": "fts/AutoFin/work/review-cycles/questionnaire-upload-transfer-v8-prod-candidate-20260714/prepared-input/questionnaire-upload-transfer-v8-prod-candidate-r1/atomic-obligations.json",
  "artifact_sha256": "8ab8b469faf5be8b231200ba66461b9f88ffe77724390775a1e4a9ecf141eaf5",
  "obligation_count": 11,
  ...
  "runner_owned_reference_fixtures": []
}
```
...
[SEED:observable oracle] Буквальный текст `Анкета клиента. Распечатайте, подпишите с клиентом и загрузите скан в заявку` отображается всегда.
...
[SEED:observable oracle] Текст информационного поля нельзя изменить ручным вводом.
...
[SEED:observable oracle] Поле добавления файла `Анкета клиента` отображается всегда.
...
**Название:** [SEED:title:ATOM-004+ATOM-005]
**Тип:** позитивный
**Приоритет:** средний
**package_id:** [SEED:package_id]
...
[SEED:observable oracle] После выбора portable jpg через проводник файл добавлен.; После добавления отображается точное имя выбранного файла.
...
[SEED:observable oracle] После Drag and Drop portable pdf файл добавлен и его имя отображается.
...
[SEED:observable oracle] В отдельных чистых итерациях jpg, png и pdf добавляются успешно.
...
[SEED:observable oracle] Ограничение `размер файла не более 40 МБ`: файл размером 50 МБ не добавляется; отображается `Документы не загружены. Проверьте соответствуют ли документы требованиям: формат jpg, png, pdf, размер не более 40 МБ`.
...
[SEED:observable oracle] Файл txt не добавляется; отображается `Документы не загружены. Проверьте соответствуют ли документы требованиям: формат jpg, png, pdf, размер не более 40 МБ`.
...
[SEED:observable oracle] После попытки добавить второй файл отображается не более одного имени файла этого типа.
