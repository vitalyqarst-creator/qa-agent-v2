...
{
  "package_version": 5,
  "package_id": "personal-data-static-properties-v4",
  "ft_slug": "AutoFin",
  "scope_slug": "4.3-prepared-shadow-personal-data-static-properties",
  "section_id": "4.3",
  "execution_profile": "simple-field-property",
  "unsupported_dimensions": [],
  "reviewed_draft_sha256": "b55efe78b81f85fae07a67d96145958641420a0424d670e43f44fcbefcd69642"
}
```
...
- source_path: `fts/AutoFin/work/review-cycles/personal-data-static-properties-shadow-v4-20260712/prepared-input/.personal-data-static-properties-v4.compiled-evidence.md`
...
{
  "coverage_gaps": [],
  "digest": "2bea08ac8094e3aa2a2cbf8a8ba14d3a3ed4fff7b5db94062d10dac8e442b937",
  "obligations": [
    {
      "atom_id": "ATOM-001",
    ...
    },
    {
      ...
      "test_intent": "Ввести синтетическое допустимое текстовое значение `Тест` в поле `Фамилия`."
    },
    {
      "atom_id": "ATOM-004",
    ...
    },
    {
      ...
      "test_intent": "Ввести синтетическое строковое значение `Тест` в поле `Фамилия`."
    },
    {
      "atom_id": "ATOM-006",
    ...
    },
    {
      ...
      "test_intent": "Ввести синтетическое допустимое текстовое значение `Тест` в поле `Имя`."
    },
    {
      "atom_id": "ATOM-009",
    ...
    },
    {
      ...
      "test_intent": "Ввести синтетическое строковое значение `Тест` в поле `Имя`."
    },
    {
      "atom_id": "ATOM-011",
    ...
    },
    {
      ...
      "test_intent": "Ввести синтетическое допустимое текстовое значение `Тест` в поле `Отчество`."
    },
    {
      "atom_id": "ATOM-014",
    ...
    },
    {
      ...
      "test_intent": "Ввести синтетическое строковое значение `Тест` в поле `Отчество`."
    }
  ],
  "package_id": "personal-data-static-properties-v4",
  "package_version": 5
...
```json
{
  ...
  "findings": [
    {
      ...
      "titles": [
        "Проверка редактируемости поля «Фамилия»",
        "Проверка строкового типа значения поля «Фамилия»"
      ],
      "traceability": [
        "OBL-003; ATOM-003",
        "OBL-005; ATOM-005"
      ...
      "required_review": "Classify as a justified multi-obligation check or require consolidation; unique titles alone are insufficient."
    },
    {
      "id": "semantic-overlap-002",
      "severity": "warning",
      "category": "duplication",
      "blocking": false,
      "test_case_ids": [
      ...
      "titles": [
        "Проверка редактируемости поля «Имя»",
        "Проверка строкового типа значения поля «Имя»"
      ],
      "traceability": [
        "OBL-008; ATOM-008",
        "OBL-010; ATOM-010"
    ...
    },
    {
      ...
      "titles": [
        "Проверка редактируемости поля «Отчество»",
        "Проверка строкового типа значения поля «Отчество»"
      ],
      "traceability": [
        "OBL-013; ATOM-013",
        "OBL-015; ATOM-015"
  ...
  "checked_paths": [
    "C:\\Users\\Пользователь\\Documents\\Виталя\\GitProjects\\qa-agent-v2\\fts\\AutoFin\\work\\review-cycles\\personal-data-static-properties-shadow-v4-20260712\\attempts\\writer-r1\\attempt-001\\stage-output\\draft.md"
  ]
}
```
...
1. Проверить наличие поля `Фамилия` в карточке заявки.
...
- Не применимо: сохранение данных не выполняется.
...
1. Проверить наличие поля `Имя` в карточке заявки.
...
1. Проверить наличие поля `Отчество` в карточке заявки.
...
1. Проверить отсутствие признака обязательности у поля `Отчество`.
