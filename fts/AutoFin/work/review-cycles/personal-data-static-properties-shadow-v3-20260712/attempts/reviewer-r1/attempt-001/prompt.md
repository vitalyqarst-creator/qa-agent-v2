...
```json
{
  ...
  "reviewed_draft_sha256": "89b54cbad634961f8dd380c641827e2beddf852f5ef2d4a0dba3d0469ac2b7c5"
}
```
...
{
  "coverage_gaps": [],
  "digest": "0987de3c0197b752ffc74a67b4a0e60c5747375c8c7f38b4f06252fd4d34644a",
  "obligations": [
    {
      "atom_id": "ATOM-001",
...
```json
{
  ...
  "findings": [],
  "checked_paths": [
    "C:\\Users\\Пользователь\\Documents\\Виталя\\GitProjects\\qa-agent-v2\\fts\\AutoFin\\work\\review-cycles\\personal-data-static-properties-shadow-v3-20260712\\attempts\\writer-r1\\attempt-001\\stage-output\\draft.md"
  ]
}
```
