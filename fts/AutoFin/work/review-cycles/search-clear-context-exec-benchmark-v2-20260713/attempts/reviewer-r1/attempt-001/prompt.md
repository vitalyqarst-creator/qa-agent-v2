...
```json
{
  ...
  "reviewed_draft_sha256": "d88aa5329150f8ac1cef5e7e10ed0a6aebb53cd9633f13b97980c1bc32bc64c1"
}
```
...
- source_path: `fts/AutoFin/work/review-cycles/search-clear-context-exec-benchmark-v2-20260713/prepared-input/.search-clear-context-exec-benchmark-v2.compiled-evidence.md`
...
```json
{"artifact":"fts/AutoFin/work/review-cycles/search-clear-context-exec-benchmark-v2-20260713/prepared-input/search-clear-context-exec-benchmark-v2/atomic-obligations.json","artifact_sha256":"bf7ac2d2212d58d1d05cce5f2aa0633a12c7e637407094dca387bae1ac1f1a22","obligation_count":4,"semantic_evidence_source":"selected-source-evidence","coverage_gaps":[],"dictionary_evidence":[],"obligations":[{"obligation_id":"OBL-001","atom_id":"ATOM-001","coverage_status":"testable","planned_test_case_id":"TC-SCCB-001","source_refs":["BSR 32","SRC-001","SRC-001.P01"],"atomic_statement":"Нажатие `Очистить` очищает применённые фильтры поиска.","observable_oracle":"После нажатия `Очистить` изменённое состояние фильтров совпадает с зафиксированным initial state.","test_intent":"Capture initial filter state, choose one visible filter value, then click `Очистить`.","dictionary_refs":[],"gap_id":"","constraint_gap_ids":[]},{"obligation_id":"OBL-002","atom_id":"ATOM-002","coverage_status":"testable","planned_test_case_id":"TC-SCCB-002","source_refs":["BSR 32","SRC-001","SRC-001.P02"],"atomic_statement":"Нажатие `Очистить` очищает применённые сортировки.","observable_oracle":"После нажатия `Очистить` изменённое состояние сортировки совпадает с зафиксированным initial state.","test_intent":"Capture initial sort state, click one sortable header until state changes, then click `Очистить`.","dictionary_refs":[],"gap_id":"","constraint_gap_ids":[]},{"obligation_id":"OBL-003","atom_id":"ATOM-003","coverage_status":"testable","planned_test_case_id":"TC-SCCB-003","source_refs":["BSR 32","SRC-001","SRC-001.P03"],"atomic_statement":"Нажатие `Очистить` очищает постраничность.","observable_oracle":"После нажатия `Очистить` изменённое состояние постраничности совпадает с зафиксированным initial state.","test_intent":"Capture initial page, navigate to `page 2`, then click `Очистить`.","dictionary_refs":[],"gap_id":"","constraint_gap_ids":[]},{"obligation_id":"OBL-004","atom_id":"ATOM-004","coverage_status":"testable","planned_test_case_id":"TC-SCCB-004","source_refs":["BSR 32","SRC-001","SRC-001.P04"],"atomic_statement":"Нажатие `Очистить` очищает состояние выделения строк.","observable_oracle":"После нажатия `Очистить` состояние выделения строк совпадает с зафиксированным initial state.","test_intent":"Capture initial row-selection state, select the `first displayed row`, then click `Очистить`.","dictionary_refs":[],"gap_id":"","constraint_gap_ids":[]}]}
```
...
```json
{
  ...
  "findings": [],
  "checked_paths": [
    "C:\\Users\\Пользователь\\Documents\\Виталя\\GitProjects\\qa-agent-v2\\fts\\AutoFin\\work\\review-cycles\\search-clear-context-exec-benchmark-v2-20260713\\attempts\\writer-r1\\attempt-001\\stage-output\\draft.md"
  ]
}
```
...
```json
{"artifact":"fts/AutoFin/work/review-cycles/search-clear-context-exec-benchmark-v2-20260713/attempts/writer-r1/attempt-001/runner-output/calibration-lifecycle.json","artifact_sha256":"8e216a49fd15ddef0c1e2678a3a44ac86771877fbd960196702549c5e3f4e064","context_profile":"conditional-state","open_count":0,"resolved_count":0,"status_counts":{},"constraint_gap_ids":[],"per_obligation_mapping_source":"verified-obligation-review-index"}
```
