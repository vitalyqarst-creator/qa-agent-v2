...
```json
{
  "artifact": "fts/AutoFin/work/review-cycles/search-clear-context-exec-benchmark-v2-20260713/prepared-input/search-clear-context-exec-benchmark-v2/atomic-obligations.json",
  "artifact_sha256": "bf7ac2d2212d58d1d05cce5f2aa0633a12c7e637407094dca387bae1ac1f1a22",
  "obligation_count": 4,
...
[SEED:observable oracle] После нажатия `Очистить` изменённое состояние фильтров совпадает с зафиксированным initial state.
...
[SEED:observable oracle] После нажатия `Очистить` изменённое состояние сортировки совпадает с зафиксированным initial state.
...
[SEED:observable oracle] После нажатия `Очистить` изменённое состояние постраничности совпадает с зафиксированным initial state.
...
[SEED:observable oracle] После нажатия `Очистить` состояние выделения строк совпадает с зафиксированным initial state.
