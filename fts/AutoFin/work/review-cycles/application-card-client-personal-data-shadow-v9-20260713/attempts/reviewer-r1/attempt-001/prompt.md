...
```json
{
  ...
  "reviewed_draft_sha256": "c99d6d2f24bc40c39788258e451eddc624f654cf364db79dcc881cc3d71a3349"
}
```
...
```json
{
  ...
  "findings": [],
  "checked_paths": [
    "C:\\Users\\Пользователь\\Documents\\Виталя\\GitProjects\\qa-agent-v2\\fts\\AutoFin\\work\\review-cycles\\application-card-client-personal-data-shadow-v9-20260713\\attempts\\writer-r1\\attempt-001\\stage-output\\draft.md"
  ]
}
```
