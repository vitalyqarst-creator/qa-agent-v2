...
```json
{
  ...
  "package_digest": "83ee169e8e5d338f8dfd9cd977d8c3bf2443538b553a47b7365d40d083fe51ab",
  "input_fingerprint": "7c59d70707bc2156c5adc93e8391bff3a55dc4e1e360a82db515149b54913cb3",
  "ft_slug": "AutoFin",
  ...
  "reviewed_draft_sha256": "02107211f064d6bc2e39760b9dc823af7b793501f267bd3b1a81c853d2427fb8"
}
```
...
```json
{
  ...
  "findings": [],
  "checked_paths": [
    "C:\\Users\\Пользователь\\Documents\\Виталя\\GitProjects\\qa-agent-v2\\fts\\AutoFin\\work\\review-cycles\\visual-assessment-medium-scope-benchmark-v5-20260714\\attempts\\writer-r1\\attempt-001\\stage-output\\draft.md"
  ]
}
```
...
```json
{"artifact":"fts/AutoFin/work/review-cycles/visual-assessment-medium-scope-benchmark-v5-20260714/attempts/writer-r1/attempt-001/runner-output/calibration-lifecycle.json","artifact_sha256":"3535b3ee9c9a3fdb82550daccee5a712e0d743fdfbfbb2e6307677dc255fe378","context_profile":"character-restriction-calibration","open_count":2,"resolved_count":0,"status_counts":{"awaiting-ui-calibration":2},"constraint_gap_ids":[],"per_obligation_mapping_source":"verified-obligation-review-index"}
```
