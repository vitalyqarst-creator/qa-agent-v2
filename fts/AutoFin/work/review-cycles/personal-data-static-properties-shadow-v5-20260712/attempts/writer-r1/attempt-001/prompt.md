...
{
  "package_version": 5,
  "package_id": "personal-data-static-properties-v5",
  "ft_slug": "AutoFin",
...
- source_path: `fts/AutoFin/work/review-cycles/personal-data-static-properties-shadow-v5-20260712/prepared-input/.personal-data-static-properties-v5.compiled-evidence.md`
- source_sha256: `24ca8c4fe02d7a6243e3b83a3949e2ab75ce506b9d9048aa6247154ef7d6c4b0`
...
- plan: PLAN-008 | check=Ввести синтетическое допустимое строковое значение `Тест` в поле `Имя`. | expected=Значение `Тест` отображается в поле `Имя`. | planned=TC-PDSP-008 | status=covered
...
- obligation: OBL-010 | property=SRC-003.P05 | source=XHTML row 58; DOCX table 6 row 5 | required=Поле `Имя` принимает строковое значение. | planned=TC-PDSP-008 | status=covered
...
- plan: PLAN-013 | check=Ввести синтетическое допустимое строковое значение `Тест` в поле `Отчество`. | expected=Значение `Тест` отображается в поле `Отчество`. | planned=TC-PDSP-013 | status=covered
...
- obligation: OBL-015 | property=SRC-004.P05 | source=XHTML row 59; DOCX table 6 row 6 | required=Поле `Отчество` принимает строковое значение. | planned=TC-PDSP-013 | status=covered
...
{
  "coverage_gaps": [],
  "digest": "e64d514c2b467d10904b6650e4922fb432c4784533625f3f504951d6fe6e55d6",
  "obligations": [
    {
      "atom_id": "ATOM-001",
    ...
    },
    {
      ...
      "planned_test_case_id": "TC-PDSP-013",
      "source_refs": [
        "SRC-004.P03"
      ],
    ...
    },
    {
      ...
      "planned_test_case_id": "TC-PDSP-014",
      "source_refs": [
        "SRC-004.P04"
      ],
...
**Название:** [SEED:title:ATOM-003+ATOM-005]
**Тип:** позитивный
**Приоритет:** средний
**package_id:** [SEED:package_id]
...
[SEED:observable oracle] Поле `Фамилия` доступно для редактирования.; Поле `Фамилия` принимает строковое значение.
...
**Название:** [SEED:title:ATOM-008+ATOM-010]
**Тип:** позитивный
**Приоритет:** средний
**package_id:** [SEED:package_id]
...
[SEED:observable oracle] Поле `Имя` доступно для редактирования.; Поле `Имя` принимает строковое значение.
...
**Название:** [SEED:title:ATOM-013+ATOM-015]
**Тип:** позитивный
**Приоритет:** средний
**package_id:** [SEED:package_id]
...
[SEED:observable oracle] Поле `Отчество` доступно для редактирования.; Поле `Отчество` принимает строковое значение.
