...
```json
{"dictionary_id":"DICT-001","dictionary_name":"Параметры визуальной оценки","source_file":"source/FT4AutoFinFinal.xhtml; source/FT4AutoFinFinal.docx; source/FT4AutoFinFinal.pdf","source_location":"Appendix 1; aggregate reference `work/test-design/14-application-card/appendix-1-visual-assessment-reference.md`","extraction_status":"extracted","active_value_count":8,"active_dictionary_ids":["DICT-101","DICT-102","DICT-103","DICT-104","DICT-105","DICT-106","DICT-107","DICT-108"],"exact_value_transport":"omitted-from-writer-context; runner-gates-and-reviewer-use-immutable-evidence"}
```

## DICT-101

```json
{"dictionary_id":"DICT-101","dictionary_name":"Признаки алкоголика","source_file":"source/FT4AutoFinFinal.xhtml; source/FT4AutoFinFinal.docx; source/FT4AutoFinFinal.pdf","source_location":"Appendix 1; aggregate reference `work/test-design/14-application-card/appendix-1-visual-assessment-reference.md`","extraction_status":"extracted","active_value_count":5,"active_dictionary_ids":[],"exact_value_transport":"omitted-from-writer-context; runner-gates-and-reviewer-use-immutable-evidence"}
```

## DICT-102

```json
{"dictionary_id":"DICT-102","dictionary_name":"Признаки наркомана","source_file":"source/FT4AutoFinFinal.xhtml; source/FT4AutoFinFinal.docx; source/FT4AutoFinFinal.pdf","source_location":"Appendix 1; aggregate reference `work/test-design/14-application-card/appendix-1-visual-assessment-reference.md`","extraction_status":"extracted","active_value_count":8,"active_dictionary_ids":[],"exact_value_transport":"omitted-from-writer-context; runner-gates-and-reviewer-use-immutable-evidence"}
```

## DICT-103

```json
{"dictionary_id":"DICT-103","dictionary_name":"Признаки бывшего заключенного","source_file":"source/FT4AutoFinFinal.xhtml; source/FT4AutoFinFinal.docx; source/FT4AutoFinFinal.pdf","source_location":"Appendix 1; aggregate reference `work/test-design/14-application-card/appendix-1-visual-assessment-reference.md`","extraction_status":"extracted","active_value_count":3,"active_dictionary_ids":[],"exact_value_transport":"omitted-from-writer-context; runner-gates-and-reviewer-use-immutable-evidence"}
```
...
```json
{"dictionary_id":"DICT-105","dictionary_name":"Поведенческие признаки потенциального неплательщика","source_file":"source/FT4AutoFinFinal.xhtml; source/FT4AutoFinFinal.docx; source/FT4AutoFinFinal.pdf","source_location":"Appendix 1; aggregate reference `work/test-design/14-application-card/appendix-1-visual-assessment-reference.md`","extraction_status":"extracted","active_value_count":6,"active_dictionary_ids":[],"exact_value_transport":"omitted-from-writer-context; runner-gates-and-reviewer-use-immutable-evidence"}
```
...
```json
{"dictionary_id":"DICT-108","dictionary_name":"Прочие признаки (комментарий обязателен)","source_file":"source/FT4AutoFinFinal.xhtml; source/FT4AutoFinFinal.docx; source/FT4AutoFinFinal.pdf","source_location":"Appendix 1; aggregate reference `work/test-design/14-application-card/appendix-1-visual-assessment-reference.md`","extraction_status":"extracted","active_value_count":1,"active_dictionary_ids":[],"exact_value_transport":"omitted-from-writer-context; runner-gates-and-reviewer-use-immutable-evidence"}
```
...
```json
{
  "artifact": "fts/AutoFin/work/review-cycles/visual-assessment-medium-scope-benchmark-v4-r1-20260714/prepared-input/visual-assessment-medium-scope-benchmark-v4/atomic-obligations.json",
  "artifact_sha256": "6fd49ada148da93d1ad059988b898eeeca70a00ddf16a7eb0b18748c2eb7bd0f",
  "obligation_count": 13,
  ...
  "runner_owned_dictionary_materializations": [
    {
      ...
      "planned_test_case_id": "TC-VAMB-005",
      "dictionary_id": "DICT-001",
      "coverage_mode": "full-hierarchy",
      "required_value_count": 47
    },
    {
      "obligation_id": "OBL-007",
      "planned_test_case_id": "TC-VAMB-006",
      "dictionary_id": "DICT-001",
      "coverage_mode": "all-leaf-values",
      "required_value_count": 39
    }
  ]
}
```
