...
- source_path: `fts/AutoFin/work/review-cycles/search-clear-context-exec-benchmark-v3-20260713/prepared-input/.search-clear-context-exec-benchmark-v3.compiled-evidence.md`
...
```json
{
  "artifact": "fts/AutoFin/work/review-cycles/search-clear-context-exec-benchmark-v3-20260713/prepared-input/search-clear-context-exec-benchmark-v3/atomic-obligations.json",
  "artifact_sha256": "ceb9f4613525caac27179060c07fdef4572d113c8f871c68f01102e96c5c9e7c",
  "obligation_count": 4,
...
[SEED:observable oracle] После нажатия `Очистить` доказанно изменённое состояние фильтров совпадает с зафиксированным initial state.
...
[SEED:observable oracle] После нажатия `Очистить` доказанно изменённое состояние сортировки совпадает с зафиксированным initial state.
...
[SEED:observable oracle] После нажатия `Очистить` доказанно изменённое состояние постраничности совпадает с зафиксированным initial state.
...
[SEED:observable oracle] После нажатия `Очистить` доказанно изменённое состояние выделения строк совпадает с зафиксированным initial state.
