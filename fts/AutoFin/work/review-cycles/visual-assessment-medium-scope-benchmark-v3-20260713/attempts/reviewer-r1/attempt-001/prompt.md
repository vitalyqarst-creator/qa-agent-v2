...
```json
{
  ...
  "reviewed_draft_sha256": "d26e38c5369c8dcb31e50f0df52da1b0f05c34ef29c78c76c1cdca5841e40fe2"
}
```
...
```json
{
  ...
  "findings": [],
  "checked_paths": [
    "C:\\Users\\Пользователь\\Documents\\Виталя\\GitProjects\\qa-agent-v2\\fts\\AutoFin\\work\\review-cycles\\visual-assessment-medium-scope-benchmark-v3-20260713\\attempts\\writer-r1\\attempt-001\\stage-output\\draft.md"
  ]
}
```
...
```json
{"artifact":"fts/AutoFin/work/review-cycles/visual-assessment-medium-scope-benchmark-v3-20260713/attempts/writer-r1/attempt-001/runner-output/calibration-lifecycle.json","artifact_sha256":"3535b3ee9c9a3fdb82550daccee5a712e0d743fdfbfbb2e6307677dc255fe378","context_profile":"character-restriction-calibration","open_count":2,"resolved_count":0,"status_counts":{"awaiting-ui-calibration":2},"constraint_gap_ids":[],"per_obligation_mapping_source":"verified-obligation-review-index"}
```
