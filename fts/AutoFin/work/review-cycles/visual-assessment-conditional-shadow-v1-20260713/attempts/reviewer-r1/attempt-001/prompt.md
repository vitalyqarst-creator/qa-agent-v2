...
```json
{
  ...
  "reviewed_draft_sha256": "9e5d26946afa948b176041428f7c7d0028ba8ed9950db4a45bffc06ba265028a"
}
```
...
- source_sha256: `13a2ff77fc9b1b701caf762a80d51dcbabdfc35fd06a1e02fb074b53643c4439`
- selectors: `full-explicit`
...
| `SRC-005` | `WP-COND` | Fixture: `Запах алкоголя / перегара / сильный запах духов, перебивающий перегар` | Appendix 1; `DICT-101` | `no_requirement_code:SRC-005` | `yes` | canary `ATOM-COND-005` |
| `SRC-006` | `WP-COND` | Fixture: `Отечность, нездоровый цвет лица, синяки под глазами` | Appendix 1; `DICT-101` | `no_requirement_code:SRC-006` | `yes` | canary `ATOM-COND-005` |
| `SRC-009` | `WP-COND` | Fixture: `Другое (комментарий обязателен)` | Appendix 1; `DICT-101` | `no_requirement_code:SRC-009` | `yes` | canary `ATOM-COND-004`; `GAP-COND-001` |
...
```json
{
  ...
  "digest": "5cc4573e169dd415a88738886da53a43be09b98e4aa6ecd125803fc73d687848",
  "obligations": [
    {
...
```json
{
  ...
  "findings": [],
  "checked_paths": [
    "C:\\Users\\Пользователь\\Documents\\Виталя\\GitProjects\\qa-agent-v2\\fts\\AutoFin\\work\\review-cycles\\visual-assessment-conditional-shadow-v1-20260713\\attempts\\writer-r1\\attempt-001\\stage-output\\draft.md"
  ]
}
```
