...
```json
{
  ...
  "reviewed_draft_sha256": "576dc046f74f982e6e01d0f26221a4ace380324b446a2323a902aa71be0ff504"
}
```
...
```json
{
  ...
  "findings": [],
  "checked_paths": [
    "C:\\Users\\Пользователь\\Documents\\Виталя\\GitProjects\\qa-agent-v2\\fts\\AutoFin\\work\\review-cycles\\personal-data-character-restrictions-shadow-v4-20260712\\attempts\\writer-r1\\attempt-001\\stage-output\\draft.md"
  ]
}
```
