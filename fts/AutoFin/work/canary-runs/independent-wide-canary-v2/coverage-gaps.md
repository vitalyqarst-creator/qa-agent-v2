...
| `BAQ-DATE-CURRENT-SOURCE` | `GAP-AW2-004`; `BSR 185`; `TC-AF43-AW2-027`; `TC-AF43-AW2-028` | Что считается "текущей датой" для проверки даты рождения контактного лица: серверная дата приложения, бизнес-дата, дата браузера пользователя или другой источник? |
