...
**?????????:** ???????
**package_id:** 4-3-contact-persons
**???????????:** OBL-BSR-180-OTHER-TEXT-INPUT; ATOM-015; ASSERT-015; BSR 180; OBL-BSR-187-ADD-FULL-CONTACT-ROW; ATOM-025; ASSERT-025; BSR 187
**?????? ?????????????:** expected-fail-product-defect
**UI evidence:** `work/ui-automation-prep/postfinal-v2-rc5-ui-calibration/evidence/screenshots/contact-relation-other-selected.png`
**Product decision:** `work/ui-automation-prep/postfinal-v2-rc5-ui-calibration/post-ui-product-decisions.md#DEC-UI-001`
...
**?????????:** ???????
**package_id:** 4-3-contact-persons
**???????????:** OBL-SRC-ROW-006-RELATION-REQUIRED-AFTER-ADD; ATOM-032; ASSERT-032; OBL-BSR-187-ADD-FULL-CONTACT-ROW; ATOM-025; ASSERT-025; BSR 187
**?????? ?????????????:** automation-ready
**UI evidence:** `work/ui-automation-prep/postfinal-v2-rc5-ui-calibration/evidence/per-tc/TC-CP-6560C2E054.md`
...
???? `????????? ? ????????? *` ???????? ?????? ? ???????? invalid/required state. Exact error text ?? ???????????, ?????? ??? ? UI-calibration ??? ?????? ??????????? ???? ????????? ??????? ????????? ?? ???????????.
...
**?????????:** ???????
**package_id:** 4-3-contact-persons
**???????????:** OBL-BSR-182-PHONE-10-DIGITS; ATOM-018; ASSERT-018; BSR 182; OBL-BSR-187-ADD-FULL-CONTACT-ROW; ATOM-025; ASSERT-025; BSR 187
**?????? ?????????????:** automation-ready
**UI evidence:** `work/ui-automation-prep/postfinal-v2-rc5-ui-calibration/evidence/per-tc/TC-CP-B01529711C.md`
...
- ??? ????? `99912345678` ?????? 11-? ????? ????????????/??????????, ???????????? ???????? ???????? `+7 (999) 123-45-67`.
- ??? ????? `99912A4567` ????? ?? ??????????? ? ????.
- ???????? ???????? `999123456` ????????? ??? blur.
...
**?????????:** ???????
**package_id:** 4-3-contact-persons
**???????????:** OBL-SRC-ROW-007-PHONE-REQUIRED-AFTER-ADD; ATOM-033; ASSERT-033; OBL-BSR-187-ADD-FULL-CONTACT-ROW; ATOM-025; ASSERT-025; BSR 187
**?????? ?????????????:** automation-ready
**UI evidence:** `work/ui-automation-prep/postfinal-v2-rc5-ui-calibration/evidence/per-tc/TC-CP-C76A595256.md`
...
???? `???????` ???????? ?????? ? ???????? invalid empty required state. Exact error text ?? ???????????, ?????? ??? ????????? ??????? ????????? ??? ???????? ??????????? ???? ? UI-calibration ?? ???????????.
...
**?????????:** ???????
**package_id:** 4-3-contact-persons
**???????????:** OBL-BSR-185-BIRTHDATE-NOT-FUTURE; ATOM-022; ASSERT-022; BSR 185; OBL-BSR-187-ADD-FULL-CONTACT-ROW; ATOM-025; ASSERT-025; BSR 187
**?????? ?????????????:** automation-ready
**UI evidence:** `work/ui-automation-prep/postfinal-v2-rc5-ui-calibration/evidence/per-tc/TC-CP-7EC8C7FA5A.md`
...
??????? ???? ???????? ? ???? `???? ????????`, ?? ???? ???????? invalid state. Exact error text ?? ???????????, ?????? ??? ? UI-calibration ????????? ??????? ????????? ??? ???? ???????? ??????????? ???? ?? ???????????.
...
**?????????:** ???????
**package_id:** 4-3-contact-persons
**???????????:** OBL-SRC-ROW-008-BIRTHDATE-REQUIRED-AFTER-ADD; ATOM-034; ASSERT-034; OBL-BSR-187-ADD-FULL-CONTACT-ROW; ATOM-025; ASSERT-025; BSR 187
**?????? ?????????????:** automation-ready
**UI evidence:** `work/ui-automation-prep/postfinal-v2-rc5-ui-calibration/evidence/per-tc/TC-CP-30984FE5C2.md`
