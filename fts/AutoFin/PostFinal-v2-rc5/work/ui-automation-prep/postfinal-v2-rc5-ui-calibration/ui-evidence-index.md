...
| TC-CP-BF2F522CE8 | log | fts/AutoFin/PostFinal-v2-rc5/work/ui-automation-prep/postfinal-v2-rc5-ui-calibration/evidence/per-tc/TC-CP-BF2F522CE8.md | confirmed; Невалидный ввод имени очищается после blur |
...
| TC-CP-351CD544DE | log | fts/AutoFin/PostFinal-v2-rc5/work/ui-automation-prep/postfinal-v2-rc5-ui-calibration/evidence/per-tc/TC-CP-351CD544DE.md | confirmed; Невалидный ввод фамилии очищается после blur |
...
| TC-CP-C0C583C405 | log | fts/AutoFin/PostFinal-v2-rc5/work/ui-automation-prep/postfinal-v2-rc5-ui-calibration/evidence/per-tc/TC-CP-C0C583C405.md | confirmed; Обязательность фамилии как DaData/autocomplete поля |
...
| TC-CP-C5BCDBF312 | log | fts/AutoFin/PostFinal-v2-rc5/work/ui-automation-prep/postfinal-v2-rc5-ui-calibration/evidence/per-tc/TC-CP-C5BCDBF312.md | confirmed; Невалидный ввод отчества очищается после blur |
