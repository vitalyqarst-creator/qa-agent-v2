...
- `tc_id`: TC-CP-351CD544DE
- `source_test_case_file`: `test-cases/4-3-contact-persons.md`
- `scope`: Contact persons / family name input
...
- What UI reaction is displayed when a digit or disallowed special character is entered in `Фамилия`?

## Executed steps

1. Filled `Фамилия` with `Иван-Петров1`, then blurred.
2. Filled `Фамилия` with `Иван-Петров@`, checked before blur and after blur.
