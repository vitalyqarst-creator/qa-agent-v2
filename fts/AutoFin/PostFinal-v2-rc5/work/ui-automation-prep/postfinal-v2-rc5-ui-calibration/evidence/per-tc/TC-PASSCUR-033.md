...
- Expected result should say `123` clears on blur and the field shows `Обязательно к заполнению`; no length-specific visible message was observed.
