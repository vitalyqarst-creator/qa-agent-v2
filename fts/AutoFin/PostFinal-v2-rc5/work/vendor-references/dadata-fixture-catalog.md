...
| `FX-DADATA-PARTY-ACTIVE-WORKADDR-001` | `suggestions-found` | `7707083893` | `ПАО СБЕРБАНК`; status=`ACTIVE`; ОПФ=`ПАО`; address.value=`г Москва, ул Вавилова, д 19`; address.unrestricted_value=`117312, г Москва, Академический р-н, ул Вавилова, д 19` | `dadata-fixtures/FX-DADATA-PARTY-ACTIVE-WORKADDR-001/FX-DADATA-PARTY-ACTIVE-WORKADDR-001.response.json`; `dadata-fixtures/FX-DADATA-PARTY-ACTIVE-WORKADDR-001/FX-DADATA-PARTY-ACTIVE-WORKADDR-001.verification.json` | `2026-07-29T06:06:27.056361Z` | `ea5fe50291bb48b1114c6560ac6ec4196c5f79f99e9f609da594b4847dd0d9b0` | `verified-once / revalidate-on-failure` | `verified-live-response` | `pending-employment-writer` |
...
## Exact Components: FX-DADATA-PARTY-ACTIVE-WORKADDR-001
...
- Неразобранный адрес: `117312, г Москва, Академический р-н, ул Вавилова, д 19`.
