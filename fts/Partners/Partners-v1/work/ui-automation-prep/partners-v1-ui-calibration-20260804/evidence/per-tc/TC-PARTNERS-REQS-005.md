...
Counter functionality near header not implemented/observable as expected in old TC.

## Data Used

Actual stand data under АО "СОГАЗ"; no stable editable requisite action observed.
