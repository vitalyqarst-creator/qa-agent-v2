...
Previous manual/recheck confirmed selecting ПАО СБЕРБАНК fills name, legal address, INN, KPP, OGRN.
...
- [TC-PARTNERS-CARD-008-after-inn-select-autofill.png](../screenshots/TC-PARTNERS-CARD-008-after-inn-select-autofill.png)
