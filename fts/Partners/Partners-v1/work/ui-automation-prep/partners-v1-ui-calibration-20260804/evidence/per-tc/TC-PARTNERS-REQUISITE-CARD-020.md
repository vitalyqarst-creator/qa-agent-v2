# TC-PARTNERS-REQUISITE-CARD-020
...
Invalid date 33.13.2026 cleared on blur without separate error text.
...
- [TC-PARTNERS-REQUISITE-CARD-020-invalid-date-cleared.png](../screenshots/TC-PARTNERS-REQUISITE-CARD-020-invalid-date-cleared.png)
